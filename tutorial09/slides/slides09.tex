...
\begin{frame}
  ...
  \lstinputlisting[language={}, basicstyle=\scriptsize, backgroundcolor=\color{listingbg}, linerange={13-16}]{../src/poisson.ufl}
  \vfill
  \begin{itemize}
...
\begin{frame}
  ...
  \lstinputlisting[basicstyle=\small, backgroundcolor=\color{listingbg}]{heatequation_gen.ufl}
\end{frame}
