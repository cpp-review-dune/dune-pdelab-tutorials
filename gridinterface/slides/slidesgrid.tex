...
% \begin{frame}
%   \frametitle{Test 1}
%   \raisebox{-.5\height}{\rule{1mm}{0.2\textheight}}
%   \raisebox{-.5\height}{\rule{1mm}{0.4\textheight}}
%   \raisebox{-.5\height}{\rule{1mm}{0.6\textheight}}
%   \raisebox{-.5\height}{\rule{1mm}{0.8\textheight}}
%   \raisebox{-.5\height}{\rule{1mm}{\textheight}}
% \end{frame}

% \begin{frame}[t]
%   \frametitle{Test 2}
%   \raisebox{-\height}{\rule{1mm}{0.8\textheight}}
%   %\raisebox{-\height}{\rule{1mm}{\textheight}}
% \end{frame}
  ...
  \item \structure{Discretization Modules}
    ...
    \begin{onlyenv}<6>
      ...
      \item[Goals:] allow people to\ldots{}\scriptsize
        \begin{itemize}
        \item get credit for their innovations
...
\draw[thick] (2,0) -- (3,0) -- (2,1) -- cycle;

\draw[line width=1pt,red] (1.5,0) -- (1.5,1);

\draw[thick] (0,0) rectangle (1,1);

\draw[thick,black!20!white] (1.3,4) -- (2.5,4.2) -- (2,5.2) -- (0.8,5) -- cycle;
\draw[thick] (1.8,3) -- (1.3,4) -- (2.5,4.2) -- cycle;
\draw[thick] (1.8,3) -- (0.8,5) -- (0,4.7) -- (0.3,2.8) -- cycle;
\draw[thick] (0.95,0.5) -- (1.05,0.5);
...
\structure{Elementwise divergence} of a vector field:
\begin{equation*}
\int_{E} \nabla\cdot f(x) \,dx = \int_{\partial E} f\cdot n_E \,ds
\end{equation*}
\pause
\bigskip
Consider the \structure{first-order linear PDE}
$$ \partial_t u + \nabla\cdot(vu) = 0$$
...
\begin{onlyenv}<presentation>
  \begin{frame}
    ...
    \item grid creation and I/O\\
      \medskip
      \uncover<2->{\rightarrownice \emph{2nd lecture today.}}
%      \medskip
%    \item I/O
%      \medskip
      \pause\pause
...
\begin{frame}
  ...
  \structure{Doxygen} class documentation
...
\begin{frame} \frametitle<presentation>{Further Reading}
    ...
    \bibitem[Bastian et al. (2021)]{dune2021}
...
Files involved are:
% finitevolume.cc  fv.hh  grid-exercise1.cc  integration.cc
\begin{enumerate}[1)]
...
\end{enumerate}
\begin{uncoverenv}<4>
  \structure{Now lets go to the code \ldots}
\end{uncoverenv}
\end{frame}
