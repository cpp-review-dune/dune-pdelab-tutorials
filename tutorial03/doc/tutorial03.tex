...
\lstinputlisting[linerange={62-65},
basicstyle=\ttfamily\small,
frame=single,
...
$u_g(x,t) = \sin(2\pi t)*\prod_{i=1}^{d-1} \sin(\pi x_i)$:
\lstinputlisting[linerange={44-52},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/problem.hh}
...
\lstinputlisting[linerange={85-87},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={88-95},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
can be instatiated:
\lstinputlisting[linerange={111-116},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
filled with data
\lstinputlisting[linerange={117-119},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
and the first file is written
\lstinputlisting[linerange={120-120},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}

Now the time loop is under user control:
\lstinputlisting[linerange={123-141},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
