...
class NitscheNonlinearPoissonFEM :
  public Dune::PDELab::
    NumericalJacobianVolume<NitscheNonlinearPoissonFEM<Param,FEM> >,
  public Dune::PDELab::
    NumericalJacobianApplyVolume<NitscheNonlinearPoissonFEM<Param,FEM> >,
  public Dune::PDELab::
    NumericalJacobianBoundary<NitscheNonlinearPoissonFEM<Param,FEM> >,
  public Dune::PDELab::
    NumericalJacobianApplyBoundary<NitscheNonlinearPoissonFEM<Param,FEM> >,
...
public:
  ...
  NitscheNonlinearPoissonFEM (Param& param_, Real stab_,int incrementorder_=0)
    : param(param_), stab(stab_), incrementorder(incrementorder_)
  {}
