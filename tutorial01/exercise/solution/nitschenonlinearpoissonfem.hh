...
class NonlinearPoissonFEM :
  ...
  public Dune::PDELab::
    NumericalJacobianBoundary<NonlinearPoissonFEM<Param,FEM> >,
  public Dune::PDELab::
    NumericalJacobianApplyBoundary<NonlinearPoissonFEM<Param,FEM> >,
...
public:
  ...
  NonlinearPoissonFEM (Param& param_, Real stab_,int incrementorder_=0)
