...
finite elements in dimension 1, 2 and 3 is realized by the file
\lstinline{tutorial00.cc} which includes several other files containing different
solution components:
\begin{enumerate}[1)]
...
singleton:
\lstinputlisting[linerange={65-70},
...
\lstinputlisting[linerange={105-111},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/tutorial00.cc}
...
\lstinputlisting[linerange={118-121},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/tutorial00.cc}
...
\lstinputlisting[linerange={122-122},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/tutorial00.cc}
...
The first two lines set up a finite element map of the type
...
\lstinputlisting[linerange={37-38},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={41-42},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={45-45},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={49-50},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={53-62},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={65-66},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
for this:
\lstinputlisting[linerange={69-70},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={71-71},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={74-76},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\lstinputlisting[linerange={77-84},
basicstyle=\ttfamily\small,
frame=single,
backgroundcolor=\color{listingbg}]{../src/driver.hh}
...
\subsection{Classes \lstinline{FFunction} and \lstinline{GFunction}}
