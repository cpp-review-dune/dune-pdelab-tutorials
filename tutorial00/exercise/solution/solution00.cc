 ...
 *
 * - If you want to see the changes to the source we recommend using a diff.
 * - If you want to solve exercise 2 search for lines starting with
 *   '//= Exercise 2' and comment/uncomment appropriate lines.
 */
