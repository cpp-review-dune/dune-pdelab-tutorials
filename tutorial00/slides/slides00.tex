...
\filldraw[thick,fill=duneorange] (2,6.5)  rectangle (7,7.5);
\node at (4.5,7) {\lstinline{dune-pdelab}};
\filldraw[thick,fill=duneorange] (1.5,8)  rectangle (7.5,9);
...
\filldraw[thick,fill=dunelightblue] (10,7.5)  rectangle (14,8.5);
\node at (12,8.25) {\lstinline{dumux}};
